import pygame
import sys
from settings import screen_width, screen_height, button_pos, button_neg
from sprites import Resistor, Lamp, Batery, Button, Mult
from overlay import Overlay, InputText
...
class Game:
    def __init__(self):
        ...
        self.info_surf = pygame.image.load('C:/Users/renan/PycharmProjects/Simulação_Resistor/imgs/info.png')
