...
class Lamp:
    ...
    def import_assets(self):
        lamp_surf = [pygame.image.load(f'C:/Users/renan/PycharmProjects/Simulação_Resistor/imgs/lamp/{i}.gif').convert_alpha() for i in range(1, 10)]
...
class Batery:
    def __init__(self, cur, volt=9):
        self.cur = cur
        self.volt = [volt]
        self.image = pygame.image.load('C:/Users/renan/PycharmProjects/Simulação_Resistor/imgs/bateria/1.jpg').convert_alpha()
...
class Button:
    def __init__(self, pos, r_color, r_num, name, div,):
        ...
        if self.name == 'mult':
            ...
            button = pygame.image.load(f'C:/Users/renan/PycharmProjects/Simulação_Resistor/imgs/button/{name}.png').convert_alpha()
...
class Mult:
    ...
    def import_assets(self):
        self.frames = []
        for i in range(3):
            path = f'C:/Users/renan/PycharmProjects/Simulação_Resistor/imgs/multimetro/{i}.jpg'
